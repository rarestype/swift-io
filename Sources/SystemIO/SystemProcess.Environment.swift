...
extension SystemProcess {
    @frozen public struct Environment: Sendable {
        @usableFromInline var encoder: EnvironmentEncoder
        @usableFromInline var inherit: Bool

        @inlinable init(inherit: Bool) {
            self.encoder = .init()
