...
@frozen public struct FileSystemStats: Identifiable, Equatable, Sendable {
    ...
    public let fragmentCount: UInt
    public let fragmentSize: UInt

    public let blocksFreeForUnprivileged: UInt
    public let blocksFree: UInt
    public let blockSize: UInt

    public let inodesFreeForUnprivileged: UInt
    public let inodesFree: UInt
    public let inodeCount: UInt

    public let maxNameLength: UInt
